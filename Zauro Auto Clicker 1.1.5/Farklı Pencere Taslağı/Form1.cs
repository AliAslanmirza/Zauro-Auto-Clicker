    ...
    public partial class Form1 : Form
    {
        ...
        private void radioButton2_CheckedChanged_1(object sender, EventArgs e)
        {
            if (radioButton2.Checked == true)
            {
                ...
                if (uyarıgoster == true)
                {
                    MessageBox.Show("This setting is during development stage, please use the recommended settings.", "Zauro Auto Clicker", MessageBoxButtons.OK,MessageBoxIcon.Warning);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            this.Size = new System.Drawing.Size(this.Width, 75);
        ...
        {
            panel3.Visible = true;
            this.Size = new System.Drawing.Size(this.Width, 415);
        }
